 ...
 */
public class CopyOfBoolBoolOps_theoneforpercy extends Exp {

	private CopyOfBoolBoolOps_theoneforpercy(){
		exps = new LinkedList();
	}

	private CopyOfBoolBoolOps_theoneforpercy(int type, Set<Exp> entries){
		op_type=type;
		exps = new LinkedList();
		for (Exp e : entries){
			exps.add(e);
	...
	public CopyOfBoolBoolOps_theoneforpercy(String input,Map vars){
		exps = new LinkedList();
	...
	static public CopyOfBoolBoolOps_theoneforpercy makeConj(Exp one, Exp two){
		CopyOfBoolBoolOps_theoneforpercy result = new CopyOfBoolBoolOps_theoneforpercy();
		result.op_type = CONJ;
		result.exps.add(one);
		result.exps.add(two);
	...
	static public CopyOfBoolBoolOps_theoneforpercy makeConj(Exp one){
		CopyOfBoolBoolOps_theoneforpercy result = new CopyOfBoolBoolOps_theoneforpercy();
		result.op_type = CONJ;
		result.exps.add(one);
	...
	static public CopyOfBoolBoolOps_theoneforpercy makeDisj(Exp one, Exp two){
		CopyOfBoolBoolOps_theoneforpercy result = new CopyOfBoolBoolOps_theoneforpercy();
		result.op_type = DISJ;
		result.exps.add(one);
		result.exps.add(two);
	...
	static public CopyOfBoolBoolOps_theoneforpercy makePair(int type, Exp one, Exp two){
		CopyOfBoolBoolOps_theoneforpercy result = new CopyOfBoolBoolOps_theoneforpercy();
		result.op_type = type;
		result.exps.add(one);
		result.exps.add(two);
	...
	public Exp simplify(List<Var> vars){
		...
		for (int i=0; i<exps.size(); i++){
			...
			if(exps.get(i) instanceof CopyOfBoolBoolOps_theoneforpercy && exps.get(i).getHeadString().equals(this.getHeadPairs())){
				CopyOfBoolBoolOps_theoneforpercy e= (CopyOfBoolBoolOps_theoneforpercy) exps.get(i).simplify(vars);
				exps2.addAll(e.exps);
			}else
	...
	public Exp replace(Exp olde, Exp newe){
		...
		if (olde instanceof CopyOfBoolBoolOps_theoneforpercy){
			CopyOfBoolBoolOps_theoneforpercy other = (CopyOfBoolBoolOps_theoneforpercy)olde;
		...
		for (int i=0; i<exps.size(); i++){
			...
			if ((op_type==CONJ || op_type==DISJ)
					&& e instanceof CopyOfBoolBoolOps_theoneforpercy){
				CopyOfBoolBoolOps_theoneforpercy b = (CopyOfBoolBoolOps_theoneforpercy)e;
	...
	public CopyOfBoolBoolOps_theoneforpercy raiseDisjDups(){
		if (exps.size()==0) return this;
		if (op_type==DISJ){
			for (int i=0; i<exps.size(); i++){
				if (!(exps.get(i) instanceof CopyOfBoolBoolOps_theoneforpercy)) return this;		    
				CopyOfBoolBoolOps_theoneforpercy b = (CopyOfBoolBoolOps_theoneforpercy)exps.get(i);
				if (b.op_type!=CONJ) return this;
			}
			List common = new LinkedList();
			CopyOfBoolBoolOps_theoneforpercy one = (CopyOfBoolBoolOps_theoneforpercy)exps.get(0);
			for (int i=0; i<one.exps.size(); i++){
				Exp e = (Exp)one.exps.get(i);
				boolean found = true;
				for (int j=1; j<exps.size(); j++){
					CopyOfBoolBoolOps_theoneforpercy other = (CopyOfBoolBoolOps_theoneforpercy)exps.get(j);
				...
				if (found){
					common.add(e);
					for (int j=0; j<exps.size(); j++){
						CopyOfBoolBoolOps_theoneforpercy b = (CopyOfBoolBoolOps_theoneforpercy)exps.get(j);
						b.exps.remove(e);
					}
				}
			}
	...
	public boolean equals(Object o){
		if (o instanceof CopyOfBoolBoolOps_theoneforpercy){
			CopyOfBoolBoolOps_theoneforpercy c = (CopyOfBoolBoolOps_theoneforpercy)o;
		...
		if (type==null || type().equals(type)){	 
			...
			for (Set<Exp> subset : subsets) {
				if (subset.size()>1 
						...
						&& subset.size()<3){
					result.add(new CopyOfBoolBoolOps_theoneforpercy(op_type,subset));
				}
			}
		}
		Exp e;
